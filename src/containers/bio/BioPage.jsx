      ...
      <div className={styles.BioContainer}>
        <span className={styles.Person}>
          ...
          <div className={styles.links}>
            ...
            <a className={styles.github} href="https://github.com/sarah-svg">
              <img
        ...
        <span className={styles.Person}>
          ...
          <p>
            A software engineer who loves finding simple solutions to complex
            problems, working with a team towards a shared goal, and Stonks.
            Always love those stonks!
          </p>
          <div className={styles.links}>
            <a
              className={styles.linkedin}
        ...
        <span className={styles.Person}>
          ...
          <p>
            A full stack Javascript engineer who loves to create, fix bugs and
            discuss new and interesting ideas.
          </p>
          <div className={styles.links}>
            <a
              className={styles.linkedin}
            ...
            <a className={styles.github} href="https://github.com/jumpybuns">
              <img
                className="githublogo"
                alt="githublogo"
                src={GitHub}
        ...
        <span className={styles.Person}>
          ...
          <p>
            A full-stack software developer who loves to get down and dirty with
            code, and turn it into awesome things that help humans!
          </p>
          <div className={styles.links}>
            <a
              className={styles.linkedin}
